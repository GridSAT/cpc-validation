...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "CPC RC, deterministic digital, and FPGA execution backends."
        )
    )
...
def main() -> int:
    ...
    print(
        "CPC Tri-Backend Benchmark Validation"
    )
    print(
        "===================================="
    )
    ...
    print(
        "FPGA semantic match:    "
        f"{fpga_semantic}/{total} "
        f"{'PASS' if fpga_semantic == total else 'FAIL'}"
    )
